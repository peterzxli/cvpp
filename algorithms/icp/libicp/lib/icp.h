...
public:
  ...
  //         R ....... initial rotation MatICP
  //         t ....... initial translation vector
  //         indist .. inlier distance (if <=0: use all points)
  // output: R ....... final rotation MatICP
  //         t ....... final translation vector
  void fit(double *T,const int32_t T_num,MatICP &R,MatICP &t,const double indist);
  
private:
  
  // iterative fitting
  void fitIterate(double *T,const int32_t T_num,MatICP &R,MatICP &t,const std::vector<int32_t> &active);
  
  // inherited classes need to overwrite these functions
  virtual double               fitStep(double *T,const int32_t T_num,MatICP &R,MatICP &t,const std::vector<int32_t> &active) = 0;
  virtual std::vector<int32_t> getInliers(double *T,const int32_t T_num,const MatICP &R,const MatICP &t,const double indist) = 0;
