...
private:
  ...
  double fitStep (double *T,const int32_t T_num,MatICP &R,MatICP &t,const std::vector<int32_t> &active);
  std::vector<int32_t> getInliers (double *T,const int32_t T_num,const MatICP &R,const MatICP &t,const double indist);
};
