...
void setupSBA(SysSBA &sys)
{
    ...
    for (i = 0; i < points.size(); i++)
    {
      ...
      temppoint.x() += 0.0;//drand48() - 0.5;
      temppoint.y() += 0.0;//drand48() - 0.5;
      temppoint.z() += 0.0;//drand48() - 0.5;
    ...
    for (i = 1; i < sys.nodes.size(); i++)
    {
      ...
      temptrans.x() += 0.1;//transscale*(drand48() - 0.5);
      temptrans.y() += 0.1;//transscale*(drand48() - 0.5);
      temptrans.z() += 0.1;//transscale*(drand48() - 0.5);
      tempqrot.x() += 0.2;//rotscale*(drand48() - 0.5);
      tempqrot.y() += 0.2;//rotscale*(drand48() - 0.5);
      tempqrot.z() += 0.2;//rotscale*(drand48() - 0.5);
      tempqrot.normalize();
...
//    ros::Duration(5.0).sleep();
    ...
    for( int i = 0 ; i < sys.nodes.size() ; i++ )
    {
        ...
        std::cout << sys.nodes[i].trans(0) << " "
                  << sys.nodes[i].trans(1) << " "
                  << sys.nodes[i].trans(2) << std::endl;
        std::cout << sys.nodes[i].qrot.w() << " "
                  << sys.nodes[i].qrot.x() << " "
                  << sys.nodes[i].qrot.y() << " "
                  << sys.nodes[i].qrot.z() << std::endl;
    }
