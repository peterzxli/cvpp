...
#include <cvpp/algorithms/gaussian_processes/models/gp_sparse.h>
...
int main( int argc , char* argv[] )
{
    ...
    if( gp.lmls().n() >= 10 )
    {
        if( d == 1 ) disp( "Sanity Check" , gp.lmls()[9].y , 634.05474 );
        if( d == 2 ) disp( "Sanity Check" , gp.lmls()[9].y , 508.81959 );
    }
